...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            pObject.setUserEmail(user_email);
            pObject.setPassword(user_password);
            List<RegisterBean> list = new ArrayList<>(); //take a list

            list = UserLoginValidate.getUsers(user_email, user_password); //send the values id and password to vadlidate class of getUsers method and storing the resultset in list
            if (!(list.isEmpty())) {
